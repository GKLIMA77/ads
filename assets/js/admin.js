...
function definirValorEl(id, valor) {
    const el = getEl(id);
    if (el)
        el.value = valor;
}
...
function fecharModal(id) {
    ...
    const el = getEl(id);
    if (el)
        (_a = bootstrap.Modal.getInstance(el)) === null || _a === void 0 ? void 0 : _a.hide();
}
// ── API ───────────────────────────────────────────────────────────────────────
...
window.editarCliente = function (id) {
    ...
    definirValorEl("cli-telefone", (_a = c.telefone) !== null && _a !== void 0 ? _a : "");
    definirValorEl("cli-email", (_b = c.email) !== null && _b !== void 0 ? _b : "");
    abrirModal("modalCliente");
};
