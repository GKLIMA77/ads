...
<body class="login-page">
  <main class="login-card">
    ...
    <a class="login-voltar" href="../site/index.php"><i class="fa-solid fa-arrow-left me-1"></i>Voltar para o site</a>
  </main>
...
<div class="d-flex">
  ...
  <div class="sidebar">
    ...
    <nav class="nav-side d-flex flex-column">
      ...
      <hr>
      <a href="admin.php?sair=1&redirect=../site/index.php" class="nav-link"><i class="fas fa-home me-2"></i>Ver Site</a>
